...
def search_data(sequence_length, num_of_depend, label_start_idx,
    ...
    num_of_depend: int, the number of points history data(num_his)
    ...
    return x_idx[::-1]   # list[(start_idx, end_idx)]
...
def get_sample_indices(data_sequence, num_of_weeks, num_of_days, num_of_hours,
    ...
    label_start_idx: int, the first index of predicting target, The point where the predicted value starts
    num_for_predict: int,
    ...
    #print("label_start_idx:",label_start_idx,"  num_for_predict:",num_for_predict)
    #print("data_sequence.shape[0]:",data_sequence.shape[0])
